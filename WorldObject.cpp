...
{
	{
		...
		if (texFileName)
		{
			...
			lodepng::decode(textureBuffer, width, height, texFileName);
		...
		if (normMapFileName)
		{
			...
			unsigned width, height;
			lodepng::decode(normalMapBuffer, width, height, texFileName);
		...
		if (displacementMapFile)
		{
			...
			unsigned width, height;
			lodepng::decode(displaceMapBuffer, width, height, displacementMapFile);
